...
class RequestOffloadState:
    ...
    def init_class(cls, spec: OffloadingSpec) -> None:
        ...
        cls.KV_GROUP_CONFIGS = tuple(
            GroupOffloadSpec(
                group_idx=idx,
                gpu_block_size=gpu_block_size,
                offloaded_block_size=gpu_block_size * spec.block_size_factor,
                hash_block_size_factor=(gpu_block_size * spec.block_size_factor)
...
class OffloadingConnectorScheduler:
    ...
    def update_state_after_alloc(
        ...
        for group_config, group_state, group_blocks in zip(
            ...
            start_block_idx = num_locally_computed_tokens // offloaded_block_size
    ...
    def _get_reqs_to_store(self, scheduler_output: SchedulerOutput):
        ...
        for req_id, new_block_id_groups, preempted in yield_req_data(scheduler_output):
            ...
            num_gpu_blocks = num_blocks * RequestOffloadState.BLOCK_SIZE_FACTOR
            ...
            for idx, key in enumerate(new_offload_keys):
                ...
                gpu_block_idx = (
                    offloaded_block_idx * RequestOffloadState.BLOCK_SIZE_FACTOR
                )
                for i in range(RequestOffloadState.BLOCK_SIZE_FACTOR):
