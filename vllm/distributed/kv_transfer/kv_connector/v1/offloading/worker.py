...
class OffloadingConnectorWorker:
    ...
    def initialize_worker_connector(self, initialization_data):
        ...
        # Convert base.py CanonicalKVCaches to spec.py CanonicalKVCaches
        spec_tensors = []
        ...
        for group_refs in base_canonical.group_data_refs:
            ...
            spec_refs.append(spec_group)

        canonical = CanonicalKVCaches(
            tensors=spec_tensors,
            group_data_refs=spec_refs,
        )
        self._register_handlers(canonical)
